...
- Automatic Liquid swaps via Boltz plugin
...
![LunaNode BTCPay Launcher](lunanode-launcher.jpg)
...
![Bull Bitcoin Wallet](bull-bitcoin-wallet.jpg)
...
![Wallet Details with xpub](wallet-details-xpub.jpg)
...
![Create Store Interface](btcpay-create-store.jpg)
...
![Checkout Settings](btcpay-checkout-settings.jpg)
...
![Lightning Configuration](lightning-setup.jpg)
...
![Boltz Plugin Setup](boltz-plugin.jpg)
...
- [Bull Wallet Setup](https://youtu.be/s4fbc9naWj4)
